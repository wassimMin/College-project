                ...
                <div class="row">
                        <div class="col-md-12">
                             ...
                             <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Enter Student id" name="id_et"> 
                                    </div>
                                <div class="form-group row">
...
if(isset($_POST['submit'])){
    ...
    (id_et,name_prenom,matricule, class, gender, mobile, email, password_us, subject_s, date_nais) 
    VALUES
    ('$student_id','$studentname', '$matricule', '$class', '$gender', '$mobile', '$email', '$password', '$sub', '$date', NOW())";
    mysqli_query($con, $insert_student);
